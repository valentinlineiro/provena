...
export type { RawOpportunity, OpportunitySourceInput, OpportunitySource, SafeFetchOptions, ProcessedOpportunity, OpportunityUserDecision } from './opportunity-source.js'
export { validateSafeUrl, fetchSafeContent, extractJobFromHtml, UrlOpportunitySource, hashOpportunityKey } from './opportunity-source.js'

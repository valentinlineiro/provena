...
import { siteNav, renderAppShell } from './shell.js'
...
test('siteNav does not render the legacy Evaluate link in top-level navigation', () => {
...
test('renderAppShell outputs correct active section link for prepare', () => {
